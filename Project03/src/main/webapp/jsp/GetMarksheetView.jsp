...
.hm-gradient {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/pngtree.jpg');
}
...
<body class="hm-gradient">
	...
	<div>
		<form action="<%=ORSView.GET_MARKSHEET_CTL%>" method="post">
			...
			<div align="center" >
				<h1 style="font-size: 40px; padding-top: 60px; color: dark blue; margin-bottom: 10px">Get
					Marksheet</h1>
			</div>
			...
			<div class="row" style="margin-bottom:20px" >
				...
				<div class="col-md-2">
					<input type="text" name="rollNo" class="p1"
