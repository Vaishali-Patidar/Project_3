...
<div>
	...
	<jsp:useBean id="dto" scope="request"
		class="in.co.rays.project3.dto.RoleDTO" />
 ...
 --%>
		...
		<table  border="3" width="100%"  cellpadding=12px cellspacing=".6">
               ...
               %>
				<tbody>
					<%-- <tr  align="center" class="<%=((index)%2==0)?"table-info":"table-danger"%>"> --%>
					<tr align="center" style="background:white">
						<td class="text-center"><input type="checkbox"
							class="checkbox" name="ids" value="<%=dto.getId()%>">
							 <%--  <%if(userDto.getId() == bean2.getId() || userDto.getRoleId() == RoleDTO.ADMIN) {                    
                    %>
                    <%="disabled" %><% } %>  >
 --%>
