...
<body >
<jsp:useBean id="dto" scope="request" class="in.co.rays.project3.dto.FacultyDTO" />
...
<%} %>                            
            ...
            <input type="hidden" name="modifiedDatetime" value="<%=DataUtility.getTimestamp(dto.getModifiedDatetime())%>">
              		 ...
              		 <div class="input-group">
                        ...
                        <input type="text" placeholder="Enter First Name" class="form-control border" style="height: 19px ;background-color:white;" name="firstName" value="<%=DataUtility.getStringData(dto.getFirst_Name())%>">
                                </div>
              		 ...
              		 <div class="input-group">
                        ...
                        <input type="text" placeholder="Enter Last Name" class="form-control border" style="height: 19px ;background-color:white;" name="lastName" value="<%=DataUtility.getStringData(dto.getLast_Name())%>">
                                </div>
                        ...
                        <input readonly="readonly" type="text" id="datepicker" placeholder="Enter Joining Date" class="form-control border" style="height: 19px ;background-color:white;" name="joiningDob" value="<%=DataUtility.getStringData(dto.getDOJ())%>">
                                </div>
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend">
                               <span class="input-group-text" style="background-color:white-space; height: 38px; width: 45px;"><i  class="fas fa-graduation-cap"></i></span>
                                 </div>
                        <input type="text" placeholder="Enter qualification" class="form-control border" style="height: 19px ;background-color:white;" name="qualification" value="<%=DataUtility.getStringData(dto.getQualification())%>">
                                </div>
                        ...
                        <input type="text" placeholder="Enter Mobile Number" class="form-control border"  style="height: 19px ;background-color:white;" name="mobileNo" value="<%=DataUtility.getStringData(dto.getMobile_No())%>">
                                </div>
                        ...
                        <input type="text" placeholder="Enter Email" class="form-control border" style="height: 19px ;background-color:white;" name="login" value="<%=DataUtility.getStringData(dto.getEmail_id())%>">
                                </div>
